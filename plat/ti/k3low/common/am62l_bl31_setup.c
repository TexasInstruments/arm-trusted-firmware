...
const mmap_region_t plat_k3_mmap[] = {
	...
	K3_MAP_REGION_FLAT(TI_MAILBOX_TX_BASE,  TI_MAILBOX_RX_TX_SZ, MT_DEVICE | MT_RW | MT_SECURE),
	K3_MAP_REGION_FLAT(WKUP_CTRL_MMR0_BASE, WKUP_CTRL_MMR0_SIZE, MT_DEVICE | MT_RW | MT_SECURE),
	K3_MAP_REGION_FLAT(MAILBOX_SHMEM_REGION_BASE, MAILBOX_SHMEM_REGION_SZ, MT_DEVICE | MT_RW | MT_SECURE),
	{ /* sentinel */ }
};
