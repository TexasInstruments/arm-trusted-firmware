...
struct pll_data {
	 ...
	 */
	int32_t (*bin)(struct clk *clkp, uint32_t plld, uint32_t pllm,
	 ...
	 */
	uint32_t (*bin_next_pllm)(struct clk *clkp, uint32_t plld,
	 ...
	 * no such value exists.
	 */
	uint32_t (*bin_prev_pllm)(struct clk *clkp, uint32_t plld,
				  uint32_t pllm, uint32_t clkod);
 ...
 */
uint32_t pll_calc(struct clk *clkp, const struct pll_data *pll_d,
