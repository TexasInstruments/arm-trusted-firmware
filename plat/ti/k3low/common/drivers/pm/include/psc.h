 ...
 */
void lpsc_module_set_reset_iso(struct device *psc_dev,
 ...
 */
bool lpsc_module_get_reset_iso(struct device *psc_dev,
 ...
 */
void lpsc_module_set_local_reset(struct device *psc_dev,
				 struct lpsc_module *module, bool enable);
 ...
 */
void lpsc_module_set_module_reset(struct device *psc_dev,
				  struct lpsc_module *module, bool enable);
 ...
 */
bool lpsc_module_get_local_reset(struct device *psc_dev,
				 struct lpsc_module *module);
 ...
 */
uint32_t lpsc_module_get_state(struct device *psc_dev,
			       struct lpsc_module *module);
...
static inline const struct psc_drv_data *to_psc_drv_data(const struct drv_data *data)
{
