...
/* IPC register bit description
 *
 * Structure:
 *      0: Enable
 * 1 -  3: Reserved
 * 4 -  7: Command (tells Linux what type of information is sent)
 * 8 - 31: Information
 * */
...
/* IPC register bit description for IPC_SET_CMD_LPM_INFO command
 *
 * Structure:
 * 8  - 11: Last entered low power mode
 * 12 - 23: Wakeup source
 * 24 - 31: Wakeup pin
 * */
#define IPC_SET_LPM_SHIFT	8U
#define IPC_SET_LPM_MASK	GENMASK(3, 0)
#define IPC_SET_WKUP_SRC_SHIFT	12U
#define IPC_SET_WKUP_PIN_SHIFT	24U
#define WKUP_SRC_PERIPH_MASK	GENMASK(3, 0)
#define WKUP_SRC_TIMER_MASK	GENMASK(7, 5)
#define WKUP_SRC_TIMER_SHIFT	1U
#define WKUP_SRC_USB_MASK	GENMASK(10, 9)
#define WKUP_SRC_USB_SHIFT	2U
#define WKUP_SRC_IO_MASK	GENMASK(18, 16)
...
void k3low_lpm_mailbox_wakeup_info(void)
{
	...
	wkup_info = IPC_SET_EN |
		    ...
		    (k3low_lpm_mode & IPC_SET_LPM_MASK) << IPC_SET_LPM_SHIFT |
