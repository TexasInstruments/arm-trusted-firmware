...
#define lpm_serial_8250_readl	mmio_read_32
#define lpm_serial_8250_writel  mmio_write_32
...
#define UART_BASE_ADDRESS				(0x2b300000U)
...
__wkupsramfunc static void lpm_console_tx(uint8_t data)
{
	...
	lpm_serial_8250_writel((UART_BASE_ADDRESS + UART_16550_THR), data);
