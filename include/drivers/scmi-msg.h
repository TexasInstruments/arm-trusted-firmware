 ...
 * @agent_id: SCMI agent ID
 * @scmi_id: SCMI clock ID
 * Return delay or SCMI compliant error code
 */
 ...
 * @agent_id: SCMI agent ID
 * @scmi_id: SCMI clock ID
 * Return value corresponding to extended configuration type or a negative SCMI error code
 */
int32_t plat_scmi_clock_get_extended_config(unsigned int agent_id, unsigned int scmi_id);
 ...
 * Return a compliant SCMI error code
 */
int32_t plat_scmi_clock_set_extended_config(unsigned int agent_id, unsigned int scmi_id,
